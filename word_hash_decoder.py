...
if __name__ == "__main__":
    ...
    # Test Zero-Knowledge Adaptive System
    print("\n" + "=" * 50)
    print("Zero-Knowledge Adaptive System Test")
    print("=" * 50)
    
    generator = TextGeneratorWithHashDecoding()
    
    # NO training data - system starts with zero knowledge
    print("🚀 System initialized with ZERO knowledge")
    print(f"   Vocabulary size: {len(generator.vocabulary)} words")
    print(f"   Patterns learned: {len(generator.patterns)}")
    print(f"   Consciousness stage: {generator.consciousness_state['stage']}")
    
    # Test the zero-knowledge system
    test_inputs = [
        "hello",
        "how are you",
        "what do you think",
    ...
    print("\n🧪 Testing zero-knowledge adaptive responses:")
    for test_input in test_inputs:
        response = generator.generate_response(test_input)
        print(f"\n  Input: {test_input}")
        print(f"  Response: {response}")
        print(f"  Vocabulary after: {len(generator.vocabulary)} words")
        print(f"  Patterns after: {len(generator.patterns)}")
        print(f"  Consciousness: {generator.consciousness_state['stage']} ({generator.consciousness_state['growth_level']:.2f})")
